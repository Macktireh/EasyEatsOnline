...
class ProductDto:
    ...
    IProduct = api.model(
        "product",
        {
            ...
            "categoryPublicId": fields.String(
                required=False, description="Product Category publicId"
            ),
            "category": CategoryNameField(readonly=True, attribute="categoryId"),
            "price": fields.Float(required=True, description="Product price"),
            "image": fields.String(
                required=False, description="the URL of the product image"
            ),
            "description": fields.String(
                required=False, description="Product description"
            ),
            "available": fields.Boolean(
                required=False, description="Product available"
            ),
            "createdAt": fields.DateTime(
                readonly=True, description="Product created at"
            ),
            "updatedAt": fields.DateTime(
                readonly=True, description="Product updated at"
            ),
        },
        mask="{publicId, name, category, price, image, description, available, createdAt, updatedAt}",
    )

    IProductUpdate = api.model(
        "productUpdate",
        {
            "publicId": fields.String(readonly=True, description="product Identifier"),
...
class OrderDto:
    ...
    IUpdateQuantityOrder = api.model(
        "UpdateQuantityOrder",
        {
